...
dictItemsBuff = {
    ...
    'Canon en or': "Dégâts +66% | Vitesse projectiles +10% | Cadence +10%",
    'Canon à tirs doubles': "Tire un deuxième projectile à chaque tir",
    '+4 Canons': "Ajoute un canon à l'avant, à l'arrière et deux en diagonale",
    'Canon légendaire': "Dégâts +133% | Vitesse projectiles +15% | Cadence -10%",
    'Coque épicéa': "PV Max +10",
    'Coque chêne': "Vitesse Max +10%",
    'Coque en bouleau': "PV Max +10 | Vitesse Max +5%",
    'Coque en chêne massif': "PV Max +75",
    'Coque en bois magique': "PV Max +50 | Vitesse Max +20% | Chance d'esquive",
